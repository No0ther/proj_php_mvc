			 ...
			 <?php require_once 'views/layouts/search.php'?>
				 <div class="col-md-9 ">
				 	<?php if (isset($products)): ?>
				 		<p class="font24 margin_bottom_20 " class="validProduct">Result<i class="font18">(<?php echo $product_found ?> products)</i></p>
				 		...
				 		<?php endforeach;?>
				 	<?php else: ?>
				 		<p class="font24 noValid" >No result<i class="font18">(0 products found)</i></p>
				 	<?php endif;?>
				 </div>
				</div>
		<!--- End products list --->
