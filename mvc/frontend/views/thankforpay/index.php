...
<body>
								...
								<div class="row_bill_detail">
									<div class="col_bill_detail" style="width: 25%;">
										<a href="?controller=cart&action=list" style="display: block;">
					       					 <img src="../backend/public/uploadsFrontend/products/<?php echo $cart_products[$key]['info']['avatar'] ?>" alt="Fjords" style="width:70%; position: relative; left: 35px;" class="img-responsive" >
	...
	<!-- End back to top -->
	<script type="text/javascript" src="../../mvc/frontend/public/assets/js/jquery.min.js"></script>
	<script type="text/javascript" src="../../mvc/frontend/public/assets/js/bootstrap.js"></script>
	<script type="text/javascript" src="../../mvc/frontend/public/assets/js/owl.carousel.min.js"></script>
	<script type="text/javascript" src="../../mvc/frontend/public/assets/js/main.js"></script>
</body>
</html>