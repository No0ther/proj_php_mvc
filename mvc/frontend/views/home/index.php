...
?>
	...
	<section class="main container-fluid margin_bottom_30">
		<!--- Search form -->
		<form  method="post" class="form-inline text-center margin_bottom_30 sticky_form">
				<div class="form-group">
					<input type="text" name="search" class="form-control" id="search_field" placeholder="Search something....">
					<button type="submit" name="search" id="searchBtn" class="btn btn-warning">
						<i class="fa fa-search" ></i>
					</button>
					<div>
						<span  id="searchSpan" class="red_color " style="margin: 15px 0px 0px 10px;"></span>
					</div>
				</div>
