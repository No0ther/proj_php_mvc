...
<?php foreach ($categories as $category): ?>
					<li>
						<a itemprop="url" href="?controller=products&action=<?php echo $category['name']; ?>">
...
?></p>
						...
						<ul class="dropdown-menu account color_while_sm" style="">
							...
							<li class="float_right"><?php echo $_SESSION['customer']['points'] ?></li>
