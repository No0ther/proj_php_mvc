			...
			<div class="phone_section container">
				...
				<div class="row product_infomation">
					<div class="col-md-4">
						...
						<div id="product" style="width: 800px; height: 400px; overflow: hidden;cursor: move;">
							<img src='../backend/public/uploadsFrontend/products/<?php echo $product['avatar']; ?>' alt="" style="cursor: move;" />
							<?php

$name_img = $product['avatar'];
if (strpos($name_img, 'org-')) {
	for ($i = 1; $i <= 35; $i++) {
		$s = 'org-' . $i;
		$s1 = 'org-' . ($i + 1);
		$name_img = str_replace($s, $s1, $name_img);
		// echo $name_img;
		?>
									<img src='../backend/public/uploadsFrontend/products/<?php echo $name_img; ?>' alt="" style="cursor: move;" />
							<?php
}
}
?>
						    ...
						    <div id="menu1" class="tab-pane fade">
						      ...
						      <form method="post" id="comment_form">
						      	...
						      	<div class="form-group">
						      		<input type="text" name="fullname" placeholder="Type your fullname" class="form-control" value="<?php echo (isset($_SESSION['customer']['name'])) ? $_SESSION['customer']['name'] : '' ?>">
						      	</div>
						      	<div class="form-group">
	...
	<script type="text/javascript" src="views/product_detail/j360.js"></script>
