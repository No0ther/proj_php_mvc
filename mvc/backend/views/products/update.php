...
?>
	    ...
	    <div class="form-group">
	        ...
	        <div class="col-md-11" id="brand_id">
...
?>
	    ...
	    <div class="form-group">
	        ...
	        <div class="col-md-11">
	            <textarea name="description" id="category-description" class="form-control"><?php echo $product['description'] ?></textarea>
	        </div>
	    </div>
...
<script type="text/javascript">
			$("#category_id").change(function() {
				var id  = $(this).val();
				 // alert(id);
				$.ajax({
					url:'?controller=brands&action=brandajax',
					method: 'POST',
					data: {'id' : id},
