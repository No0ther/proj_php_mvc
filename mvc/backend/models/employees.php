...
class employees extends model {
	...
	public function update($request) {
		$con = $this->connection();
		$queryUpdate = "UPDATE employees SET username = '{$request['username']}' ,fullname = '{$request['fullname']}', created_by = '{$request['created_by']}' ,role = '{$request['role']}' where ID = '{$request['id']}'";
